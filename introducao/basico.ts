...
// 1. pelo terminal digitar o comando "tsc <nome do arquivo>.ts" que irá gerar um arquivo "<nome do arquivo>.js"
// 2. a partir daí é possível rodar o arquivo JavaScript pelo browser ou pelo próprio node, usando o comando "node <nome do arquivo>.js"
...
// 3. na mesma pasta root, digitar npm init -y, para criar um arquivo de configuração chamado "package.json"
...
//7. abrir um novo terminal e usar o comando "npm -w" que o typescript fica em modo WATCH e qualquer modificação do arquivo, quando salvo, ele já é compilado e a modificação aparece no browser.


var changeChapter : string = 'Chapter 1: básico'
var space : string = '-----------------------------'
